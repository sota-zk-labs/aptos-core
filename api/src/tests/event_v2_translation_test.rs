...
async fn test_event_v2_translation_coin_deposit_event() {
    ...
    // Start with the ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION feature disabled
    context
        .disable_feature(ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION)
        .await;
...
async fn test_event_v2_translation_coin_withdraw_event() {
    ...
    // Enable the ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION feature
    context
        .enable_feature(ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION)
        .await;
...
async fn test_event_v2_translation_account_coin_register_event() {
    ...
    // Make sure that the ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION feature is enabled
    context
        .enable_feature(ACCOUNT_AND_COIN_MODULE_EVENT_MIGRATION)
        .await;
